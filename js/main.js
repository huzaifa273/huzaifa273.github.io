...
//   if (!hash) {
//     // No hash in URL, display the "About Me" section by default
//     document.getElementById("about-me").style.display = "block";
//     document.getElementById("portfolio").style.display = "none";
//     document.getElementById("resume").style.display = "none";
//   } else {
//     // If a hash is present, show the corresponding section
//     document.querySelectorAll("section").forEach(function (section) {
//       section.style.display =
//         section.id === hash.substring(1) ? "block" : "none";
//     });
//   }

//   // If you want to keep the URL clean without hash when clicking navigation
